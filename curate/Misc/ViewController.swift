...
//        configuration.tokenSwapURL = URL(string: "https://curate-auth.herokuapp.com/token")
//        configuration.tokenRefreshURL = URL(string: "https://curate-auth.herokuapp.com/refresh_token")
